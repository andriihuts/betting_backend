  ...
  <div class="container-fluid py-1 px-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Settled Bet Details</li>
      </ol>          
      <h6 class="mb-1 text-gradient text-primary font-weight-bolder">Settled Bet Details</h6>
    </nav>
  </div>
</nav>
  ...
  <div class="card card-body blur shadow-blur mx-4 mt-n7 overflow-hidden">
    <div class="row gx-4">
      ...
      <div class="col-auto my-auto">
        <div class="h-100">
          <h5 class="mb-1"> Settled Bet Detail </h5>              
        </div>
      </div>          
    </div>
  </div>
